...
export function Logo({ size = 'md', className }: LogoProps) {
  ...
  // viewBox is 0 0 120 120 — width scales proportionally
  const width = height
  ...
  return (
    ...
    >
      ...
      {/* Star details in rim */}
      <text x="60" y="15" textAnchor="middle" fontSize="7" fill="rgba(200,208,220,0.4)" fontFamily="serif" fontWeight="bold">
        &#x2605;
      </text>
      <text x="60" y="109" textAnchor="middle" fontSize="7" fill="rgba(200,208,220,0.4)" fontFamily="serif" fontWeight="bold">
        &#x2605;
      </text>
    </svg>
  )
