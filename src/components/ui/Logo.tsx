...
export function Logo({ size = 'sm', 'aria-label': ariaLabel = 'Mars Mission Fund', className }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      <circle cx="60" cy="60" r="46" fill="none" stroke="rgba(200,208,220,0.08)" strokeWidth="0.5"/>
      {/* Mars planet */}
      ...
      {/* Orbital ring */}
      <ellipse cx="60" cy="60" rx="32" ry="10" fill="none" stroke="rgba(200,208,220,0.25)" strokeWidth="1" strokeDasharray="3 2" transform="rotate(-25,60,60)"/>
      {/* Coin shine highlight */}
      <ellipse cx="46" cy="36" rx="14" ry="8" fill="rgba(255,255,255,0.12)" transform="rotate(-20,46,36)"/>
      {/* Star details in rim */}
      <text x="60" y="15" textAnchor="middle" fontSize="7" fill="rgba(200,208,220,0.4)" fontFamily="serif" fontWeight="bold">★</text>
      <text x="60" y="109" textAnchor="middle" fontSize="7" fill="rgba(200,208,220,0.4)" fontFamily="serif" fontWeight="bold">★</text>
    </svg>
  )
}
